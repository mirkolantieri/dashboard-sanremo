...
/**
* The below code is refered to e2e testing for the "artists/songs details" story.
* @function artistsSongDetails
*/

(async function artistsSongDetails(){
    ...
    await element.click()
    let revealed = driver.findElement(By.linkText("2021"))
    ...
    let revealed2 = driver.findElement(By.linkText("2021"))
    ...
    let ranking2 = driver.findElement(By.xpath("(//div[@class='MuiGridListTile-tile'])[4]"))
